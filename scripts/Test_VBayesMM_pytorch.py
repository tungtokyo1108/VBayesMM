...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 13 17:08:19 2024
...
metabolites_df = metabolites.to_dataframe().T
...
losses, val_losses = model.fit(train_microbes_coo, trainY_torch, test_microbes_coo, testY_torch, epochs=200)
